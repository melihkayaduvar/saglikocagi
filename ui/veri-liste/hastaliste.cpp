    ...
    , ui(new Ui::HastaListe)
{
    ...
    connect(ui->tableWidget, &QTableWidget::itemSelectionChanged ,this, &HastaListe::tablewidget_silmesecimi);
    connect(ui->btnBilgi, &QPushButton::clicked, this, &HastaListe::bilgiTiklandi);
}
...
void HastaListe::tablewidget_silmesecimi()
{
...
void HastaListe::on_btnSil_clicked()
{
    auto selectedRanges = ui->tableWidget->selectedRanges();
    QSet<int> selectedRows;
    for (auto &range : selectedRanges) {
    ...
    if(x==QMessageBox::Yes){
        ...
        if (satir>=0) {
            ...
            VERITABANI::vt().hastalar().IdyeGoreSil(silinecekid);
        }
...
void HastaListe::on_leAra_textChanged(const QString &arg1)
{
    ara();
}


void HastaListe::on_btnHastaOlustur_clicked()
{
